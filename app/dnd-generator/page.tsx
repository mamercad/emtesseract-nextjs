...
export default function DnDGenerator() {
  ...
  return (
    <>
      {/* Screen-only gradient background */}
      <div className="fixed inset-0 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 -z-10 print:hidden" />
      
      {/* Print-only white background */}
      <div className="hidden print:block fixed inset-0 bg-white -z-10" />
