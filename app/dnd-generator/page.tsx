          ...
          <div className="bg-white rounded-lg shadow-2xl p-8">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold py-4 px-8 rounded-lg text-xl shadow-lg hover:from-purple-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                {loading ? (
                  <>
